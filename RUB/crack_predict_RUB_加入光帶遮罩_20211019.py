                    ...
                    for classId, confidence, box in zip(classes.flatten(), confidences.flatten(), boxes):
                        ...
                        if warn_mask[y_center][x_center] == 255:
                            ...
                            if not min1_defectContinue and not min5_defectHave:
                                ...
                                for i in range(len(min1_defectContinue)):
                                    if abs(x_center - min1_defectContinue[i]) < crack_width:
                                        ...
                                        print("min1 same location:", min1_count[i])
                                        break
                                if not is_crack:
                                    min1_defectContinue.append(x_center)
                                    min1_count.append(1)
                                ...
                                for i in range(len(min5_defectHave)):
                                    if abs(x_center - min5_defectHave[i]) < crack_width:
                                        ...
                                        print("min5 same location:", min5_count[i])
                                        break
                                if not is_crack:
                                    min5_defectHave.append(x_center)
                                    min5_count.append(1)
                            ...
                            if time.time() - start_min1 < 60:
                                defect_sum = sum(i > crack_count for i in min1_count)
                                if defect_sum > 0: 
                                    #發報
                                    alarm_status = True
                                    start_min1 = time.time()
                            ...
                            if time.time() - start_min5 < 300:
                                defect_sum = sum(i > crack_count for i in min5_count)
                                if defect_sum > 0: 
                                    #發報
                                    alarm_status = True
                                    start_min1 = time.time()
