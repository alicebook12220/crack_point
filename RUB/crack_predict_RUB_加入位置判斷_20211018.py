    ...
    with Camera(0) as cam:
        ...
        if (w):
            ...
            while(True):
                ...
                #start = time.time()
                classes, confidences, boxes = net.detect(image, confThreshold=0.8, nmsThreshold=0.5)
                ...
                if len(boxes) > 0:
                    for classId, confidence, box in zip(classes.flatten(), confidences.flatten(), boxes):
                        ...
                        #檢查瑕疵是否在同一位置出現3次以上
                        if not min1_defectContinue and not min5_defectHave:
                            ...
                            for i in range(len(min1_defectContinue)):
                                if abs(x_center - min1_defectContinue[i]) < 6:
                            ...
                            for i in range(len(min5_defectHave)):
                                if abs(x_center - min5_defectHave[i]) < 6:
                        ...
                        if time.time() - start_min1 < 60:
                            defect_sum = sum(i > 3 for i in min1_count)
                            if defect_sum > 0: 
                                #發報
                                alarm_status = True
                                start_min1 = time.time()
                            ...
                            defect_sum = sum(i > 3 for i in min5_count)
                            if defect_sum > 0: 
                                #發報
                                alarm_status = True
                                start_min5 = time.time()
